...
def build_revived_state(dead_state: State, max_revives: int) -> State:
    injection_extraction_state_after_browser_reopen: InjectionExtractionState = dead_state.injection_extraction_state
    if dead_state.revives > max_revives:
        injection_extraction_state_after_browser_reopen = InjectionExtractionState.TERMINATED
    elif dead_state.injection_extraction_state == InjectionExtractionState.PROMPT_INJECTED:
        injection_extraction_state_after_browser_reopen = InjectionExtractionState.PROFILE_PREPARED
    return State(
        ...
        injection_extraction_state=injection_extraction_state_after_browser_reopen,
